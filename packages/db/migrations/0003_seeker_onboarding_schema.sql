...
insert into skills (slug, display_name, category) values
  ...
  ('elektronik-betriebstechnik',       'Elektronik für Betriebstechnik',        'trade'),
  ('elektronik-energie-gebaeude',      'Elektronik für Energie- und Gebäudetechnik', 'trade'),
  ('elektronik-automatisierung',       'Elektronik für Automatisierungstechnik','trade'),
  ('zerspanungsmechanik',              'Zerspanungsmechanik',                    'trade'),
  ('metallbau-konstruktion',           'Metallbau Konstruktionstechnik',         'trade'),
  ('zentralheizung-lueftungsbau',      'Zentralheizungs- und Lüftungsbau',      'trade'),
  ('gas-wasserinstallation',           'Gas- und Wasserinstallation',            'trade'),
  ('rohrleitungsbau',                  'Rohrleitungsbau',                        'trade'),
  ('sanitärinstallation',             'Sanitärinstallation',                   'trade'),
  ('heizungsinstallation',             'Heizungsinstallation',                   'trade'),
  ('klimatechnik',                     'Klimatechnik',                           'trade'),
  ('lueftungstechnik',                 'Lüftungstechnik',                       'trade'),
  ('kaeltetechnik',                    'Kältetechnik',                          'trade'),
  ('schweisstechnik-mag',              'Schweißtechnik MAG',                    'trade'),
  ('schweisstechnik-wig',              'Schweißtechnik WIG',                    'trade'),
  ('schweisstechnik-e-hand',           'Schweißtechnik E-Hand',                 'trade'),
  ('autogenschweissen',                'Autogenschweißen',                      'trade'),
  ('loeten',                           'Weich- und Hartlöten',                  'trade'),
  ('blechbearbeitung',                 'Blechbearbeitung',                       'trade'),
  ('metallbearbeitung',                'Metallbearbeitung',                      'trade'),
  ('cnc-fraesen',                      'CNC-Fräsen',                            'trade'),
  ...
  ('wärmepumpen-installation',        'Wärmepumpen-Installation',              'trade'),
  ...
  ('serviceeinsatz-dokumentation',     'Dokumentation von Serviceeinsätzen',    'trade'),
  ...
  ('dichtheitspruefung',               'Dichtheitsprüfung',                     'trade'),
  ...
  ('wärmepumpen-diagnose',            'Wärmepumpen-Diagnose',                  'trade'),
  ('warmwasserbereitung',              'Warmwasserbereitung',                    'trade'),
  ('fussbodenheizung',                 'Fussbodenheizung',                       'trade'),
  ('heizkoerper-installation',         'Heizkörper-Installation',               'trade'),
  ('sanitärreparatur',                'Sanitärreparatur',                      'trade'),
  ...
  ('sachkunde-kaeltemittel',           'Sachkundenachweis Kältemittel',         'certification'),
  ...
  ('hubarbeitsbuehnen-schein',         'Hubarbeitsbühnen-Schein',               'certification'),
  ('sachverstaendiger-elektro',        'Sachverständigenprüfung Elektrotechnik','certification'),
  ('ausbilder-eignung',                'IHK-Ausbilder-Eignung',                  'certification'),
  ('vde-pruefung',                     'VDE-Prüfung',                           'certification'),
  ('schweisserpruefung',               'Schweißerprüfung',                     'certification'),
  ('trgs-519-asbest',                  'TRGS 519 Asbest',                        'certification'),
  ('flüssiggas-sachkunde',            'Flüssiggas-Sachkunde',                  'certification'),
  ...
  ('kettensaegen-schein',              'Kettensägenschein',                     'certification'),
  ('baumeister',                       'Baumeister-Prüfung',                    'certification'),
  ...
  ('sprache-franzoesisch',             'Französisch',                           'language'),
  ('sprache-spanisch',                 'Spanisch',                               'language'),
  ('sprache-tuerkisch',                'Türkisch',                              'language'),
  ('sprache-polnisch',                 'Polnisch',                               'language'),
  ('sprache-russisch',                 'Russisch',                               'language'),
  ('sprache-arabisch',                 'Arabisch',                               'language'),

  -- Soft skills
  ('teamfaehigkeit',                   'Teamfähigkeit',                         'soft'),
  ('kommunikation',                    'Kommunikationsfähigkeit',               'soft'),
  ('projektmanagement',                'Projektmanagement',                      'soft'),
  ('fuehrungskompetenz',               'Führungskompetenz',                     'soft'),
  ('kundenorientierung',               'Kundenorientierung',                     'soft'),
  ('problemloesung',                   'Problemlösungsfähigkeit',              'soft'),
  ('selbstorganisation',               'Selbstorganisation',                     'soft'),
  ('belastbarkeit',                    'Belastbarkeit',                          'soft'),
  ('zuverlaessigkeit',                 'Zuverlässigkeit',                       'soft'),
  ('flexibilitaet',                    'Flexibilität',                          'soft');
