// Single work-experience block. 2-column layout: date range | content.
...
export function CvExperienceBlock({
  startMonth,
  startYear,
  endMonth,
  endYear,
  ...
  return (
    <View className="flex-row gap-3 py-3">
      ...
      <View className="flex-1">
        ...
        {subtitle && subtitle !== '' && (
          <Text className="mt-0.5 text-sm text-brand-500">{subtitle}</Text>
        )}
        {bullets.length > 0 && (
